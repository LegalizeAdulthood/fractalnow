...
/**
 * \fn void safeReadString(FILE *file, char *fileName, char *dst)
 ...
 * \param dst Destination string.
 */
void safeReadString(FILE *file, char *fileName, char *dst);

/**
 * \fn uint32_t safeReadUint32(FILE *file, char *fileName)
 ...
 * \return uint32 read.
 */
uint32_t safeReadUint32(FILE *file, char *fileName);

/**
 * \fn FLOAT safeReadFLOAT(FILE *file, char *fileName)
 ...
 * \return FLOAT read.
 */
FLOAT safeReadFLOAT(FILE *file, char *fileName);

/**
 * \fn Color safeReadColor(FILE *file, char *fileName, int_fast8_t bytesPerComponent)
 ...
 * \return Color read.
 */
Color safeReadColor(FILE *file, char *fileName, int_fast8_t bytesPerComponent);
