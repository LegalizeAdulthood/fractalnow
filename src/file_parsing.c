...
inline void safeReadString(FILE *file, char *fileName, char *dst)
{
...
inline uint32_t safeReadUint32(FILE *file, char *fileName)
{
	uint32_t res;
...
inline FLOAT safeReadFLOAT(FILE *file, char *fileName)
{
	FLOAT res;
...
inline Color safeReadColor(FILE *file, char *fileName, int_fast8_t bytesPerComponent)
{
	Color res;
